'''
Original modeling_electra.py from transformers=4.3.3
'''
...
class ElectraCustomedModel(ElectraPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.embeddings = ElectraEmbeddings(config)
    ...
    def forward(
        ...
        if pooler_input is not None:
            embedding_output = torch.cat([pooler_input.unsqueeze(1), embedding_output[:, 1:, :]], dim=1)
...
class ElectraForPreTraining(ElectraPreTrainedModel):
    def __init__(self, config):
        ...
        self.electra = ElectraCustomedModel(config) # Joonwon Changed
    ...
    def forward(
        ...
        output_hidden_states=None,
        return_dict=None,
        pooler_input = None, # Joonwon Changed
    ):
        r"""
